...
use UtopiaBundle\Entity\Projet;
use UtopiaBundle\Form\ProjetType;
...
class ProjetController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('UtopiaBundle:Projet')->findAll();
     ...
     * @Method("POST")
     * @Template("UtopiaBundle:Projet:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('UtopiaBundle:Projet')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("UtopiaBundle:Projet:edit.html.twig")
     */
