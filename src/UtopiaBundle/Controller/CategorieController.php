...
use UtopiaBundle\Entity\Categorie;
use UtopiaBundle\Form\CategorieType;
...
class CategorieController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('UtopiaBundle:Categorie')->findAll();
     ...
     * @Method("POST")
     * @Template("UtopiaBundle:Categorie:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('UtopiaBundle:Categorie')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("UtopiaBundle:Categorie:edit.html.twig")
     */
